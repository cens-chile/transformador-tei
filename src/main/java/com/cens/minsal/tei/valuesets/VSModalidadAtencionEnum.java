...
public enum VSModalidadAtencionEnum {
    ...
    private String code;
    private static Map<String, VSModalidadAtencionEnum> vsSModalidadAtencionEnum = null;
    ...
    public static VSModalidadAtencionEnum fromCode(String theCode) {
        Map<String, VSModalidadAtencionEnum> c2s = vsSModalidadAtencionEnum;
        if (c2s == null) {
            c2s = new HashMap<>();
            for (VSModalidadAtencionEnum next : values()) {
                c2s.put(next.getCode(), next);
            }
            vsSModalidadAtencionEnum = c2s;
        }
